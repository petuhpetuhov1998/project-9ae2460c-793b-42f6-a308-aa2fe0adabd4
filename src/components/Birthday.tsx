      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-4 -right-4 w-16 h-16 bg-warm rounded-full opacity-60" />
            <div className="absolute -bottom-6 -left-6 w-20 h-20 bg-accent/50 rounded-full" />
          </div>

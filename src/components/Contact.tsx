            ...
            <div className="space-y-6">
              <div className="bg-sage rounded-2xl p-6 text-white">
                ...
                <div className="space-y-4">
                  <a href="tel:+73452000000" className="flex items-center gap-3 hover:opacity-80 transition-opacity group">
              ...
              <div className="bg-card rounded-2xl p-6 shadow-soft">
                ...
                <div className="flex gap-3">
                  <a 
                    ...
                    className="flex items-center gap-2 bg-[#0088cc] text-white px-4 py-3 rounded-xl font-medium hover:opacity-90 hover:scale-105 transition-all"
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 bg-[#4a76a8] text-white px-4 py-3 rounded-xl font-medium hover:opacity-90 hover:scale-105 transition-all"
                  >
